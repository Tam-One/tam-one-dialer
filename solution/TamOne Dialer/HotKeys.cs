...
namespace HDLibrary.Wpf.Input
{
    ...
    public sealed class HotKeyHost : IDisposable
    {
        ...
        public static extern bool RegisterHotKey(IntPtr hwnd,
                int id, uint modifiers, uint key);
        ...
        private void RegisterHotKey(int id, HotKey hotKey)
        {
            ...
            {
                RegisterHotKey(hwndSource.Handle, id, (uint)hotKey.Modifiers, (uint) KeyInterop.VirtualKeyFromKey(hotKey.Key));
        ...
        private static readonly SerialCounter idGen = new SerialCounter(1024); //Annotation: Can be replaced with "Random"-class
